...
//         builder.addCase(fetchAllVenues.pending,(state,action)=>{
//             state.loading=true;
//             state.error=null
           
//         })
//         builder.addCase(fetchAllVenues.fulfilled,(state,action)=>{
//             state.loading=false
//             state.Venues=action.payload.venues
//         })
//         builder.addCase(fetchAllVenues.rejected,(state,action)=>{
//             state.loading=false;
...
//     }
// })
// export const {setVenues,setError,setLoading}=VenueSlice.actions;
