...
//       const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/venue/delete`, {
//         method: 'POST',
//         headers: {
...
//       Swal.fire({
//         title: 'Deleted!',
//         text: `${venueName} has been deleted.`,
//         icon: 'success',
//         timer: 1500,
...
//   const handleEdit = async (venueName) => {
//     const { value: newVenueName } = await Swal.fire({
//       title: 'Update Venue',
//       input: 'text',
...
//         if (!value) {
//           return 'You need to enter a venue name!';
//         }
//       }
//     });
...
//       const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/venue/update`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//           'Authorization': `Bearer ${localStorage.getItem('token')}`
...
//           updated_venue_name: newVenueName 
//         })
//       });
...
//       Swal.fire({
//         title: 'Updated!',
//         text: `Venue has been updated to ${newVenueName}.`,
//         icon: 'success',
//         timer: 1500,
//         showConfirmButton: false
//       });
...
//       Swal.fire({
//         title: 'Error!',
//         text: 'Failed to update venue. Please try again.',
//         icon: 'error'
//       });
//     }
//   };
...
//     e.stopPropagation();
//     onVenueSelect && onVenueSelect(venue);
//   };
...
//         <div className="venue-table-scroll overflow-y-auto pr-1">
//           {loading ? (
...
//                   <tr 
//                     key={venue.venue_name || index} 
//                     className={`border-b border-gray-200 cursor-pointer transition-colors hover:bg-blue-50/60 ${
//                       selectedVenue?.venue_name === venue.venue_name ? 'bg-blue-50 border-blue-300' : ''
//                     }`}
//                     onClick={(e) => handleRowClick(venue, e)}
//                   >
//                     <td className="venue-table-cell py-2 sm:py-3 px-2 sm:px-4">{index + 1}. {venue.venue_name}</td>
...
//                         <button className="venue-action-btn rounded-full border border-green-500/50 bg-white flex items-center justify-center hover:bg-green-50" onClick={() => handleEdit(venue.venue_name)}>
//                           <Pencil className="text-green-600 venue-action-icon" />
//                         </button>
//                         <button className="venue-action-btn rounded-full border border-red-500/50 bg-white flex items-center justify-center hover:bg-red-50" onClick={() => handleDelete(venue.venue_name)}>
