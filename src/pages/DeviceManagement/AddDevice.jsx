  ...
  <FormControl fullWidth>
    <Select
      ...
      sx={{
        ...
        // make the closed select shorter
        "& .MuiSelect-select": {
          display: "flex",
          alignItems: "center",
        ...
        // optional: tighten the dropdown items spacing a bit
        "& .MuiMenuItem-root": {
    ...
    >
      {loading ? (
        <MenuItem value="" disabled sx={{ minHeight: `${ITEM_HEIGHT}px` }}>
          Loading venues...
        </MenuItem>
      ) : error ? (
        <MenuItem value="" disabled sx={{ minHeight: `${ITEM_HEIGHT}px` }}>
        ...
        Venues.map((venue, index) => {
          ...
          const displayName = venue.name ?? `Venue ${index + 1}`;
          return (
            <MenuItem key={id} value={id} sx={{ minHeight: `${ITEM_HEIGHT}px` }}>
              {displayName}
            </MenuItem>
          );
        })
