...
//     setOtaVersionId(e.target.value);
//   };
...
//       Swal.fire({
//         title: 'Error',
//         text: 'Please enter OTA Version ID',
//         icon: 'error'
//       });
//       return;
//     }
...
//     Swal.fire({
//       title: 'Success',
//       text: 'OTA file uploaded successfully',
//       icon: 'success'
//     });
...
//   return (
//     <div className="AddingPage brand-add-container rounded-xl shadow-sm w-full flex flex-col justify-center bg-white border border-[#E5E7EB]">
//       <h2 className="brand-add-title font-semibold mb-1 text-center">OTA Management</h2>
//       <p className="brand-add-subtitle text-gray-500 mb-6 text-center">Welcome Back! Select method to add user</p>

//       <div className="brand-add-form space-y-4 max-w-sm mx-auto w-full">
//         {/* OTA Version ID Input */}
...
//             isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300 bg-[#14B8A6]'
//           }`}
...
//               className="px-6 py-2 bg-white text-[#14B8A6] rounded-md font-medium hover:bg-gray-50 transition-colors"
//             >
//               Browse File
//             </button>
//           </div>
...
//             type="button"
//             onClick={handleSave}
//             className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-md transition duration-300 shadow-md"
//           >
//             Save
//           </button>
//           <button
...
//             className="flex-1 bg-white hover:bg-gray-50 text-red-600 font-semibold py-2.5 px-4 rounded-md border border-red-600 transition duration-300"
//           >
//             Cancel
//           </button>
//         </div>
...
//       // backend uses uploadFile.single("otaFile") -> field name must be "otaFile"
//       formData.append('otaFile', selectedFile);
//       formData.append('versionId', otaVersionId);

//       const res = await fetch(`${BASE}/ota/upload`, {
//         method: 'POST',
//         credentials: 'include',
//         headers: {
//           // Don't set Content-Type for multipart – browser will set boundary
...
//       if (res.status === 201) {
//         Swal.fire({ title: 'Success', text: 'OTA file uploaded successfully', icon: 'success' });
//         // reset
//         setOtaVersionId('');
//         setSelectedFile(null);
//         if (fileInputRef.current) fileInputRef.current.value = '';

//         // notify parent to refresh device list / re-fetch versions
...
//       } else {
//         Swal.fire({ title: 'Error', text: data?.message || 'Failed to upload OTA file', icon: 'error' });
//       }
//     } catch (err) {
//       console.error('OTA upload error:', err);
//       Swal.fire({ title: 'Error', text: err.message || 'Network error while uploading', icon: 'error' });
//     } finally {
...
//         {/* File Upload Area */}
//         <div
//           className={`relative border-2 border-dashed rounded-lg p-8 transition-colors ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300 bg-[#14B8A6]'}`}
//           onDragOver={handleDragOver}
//           onDragLeave={handleDragLeave}
//           onDrop={handleDrop}
//           style={{ backgroundColor: isDragging ? '#E6FFFA' : '#14B8A6', minHeight: '200px' }}
